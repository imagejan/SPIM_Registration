...
public class EfficientBayesianBased extends Fusion
{
	...
	public static int defaultBlendingBorderNumber = -10;
	...
	protected boolean getBlending()
	{
		if ( adjustBlending )
		{
			...
			if ( defaultBlendingBorder == null || defaultBlendingBorder.length < 3 )
				defaultBlendingBorder = new int[]{ defaultBlendingBorderNumber, defaultBlendingBorderNumber, defaultBlendingBorderNumber };
